...
public class UpdateChargeRequestValidator : CustomValidator<UpdateChargeRequest>
{
    public UpdateChargeRequestValidator(IReadRepository<Charge> chargeRepo, IReadRepository<Department> departmentRepo, IReadRepository<Folio> folioRepo, IReadRepository<Travelagent> travelagentRepo, IReadRepository<Transactionstatus> transactionstatusRepo, IStringLocalizer<UpdateChargeRequestValidator> T)
    {
