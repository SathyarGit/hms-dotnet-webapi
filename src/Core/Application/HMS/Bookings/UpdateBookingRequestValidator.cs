...
{
    public UpdateBookingRequestValidator(IReadRepository<Booking> bookingRepo, IReadRepository<Customer> customerRepo, IReadRepository<Folio> folioRepo, IReadRepository<Travelagent> travelagentRepo, IReadRepository<Bookingstatus> bookingstatusRepo, IStringLocalizer<UpdateBookingRequestValidator> T)
    {
