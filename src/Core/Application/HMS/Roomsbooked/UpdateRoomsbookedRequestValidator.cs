...
public class UpdateRoomsbookedRequestValidator : CustomValidator<UpdateRoomsbookedRequest>
{
    public UpdateRoomsbookedRequestValidator(IReadRepository<Roomsbooked> roomsbookedRepo, IReadRepository<Room> roomRepo, IReadRepository<Booking> bookingRepo, IStringLocalizer<UpdateRoomsbookedRequestValidator> T)
    {
