...
public class Accountentry : AuditableEntity, IAggregateRoot
{
    ...
    public DefaultIdType? ExpcategoryId { get; private set; }
    ...
    public Accountentry(DateTime? transactionDate, DefaultIdType? folioId, DefaultIdType? purchaseId, DefaultIdType? paymentmodeId,
                        DefaultIdType? departmentId, DefaultIdType? expcategoryId, int? amount, DefaultIdType? transactiontypeId, string? description)
    {
    ...
    public Accountentry Update(DateTime? transactionDate, DefaultIdType? folioId, DefaultIdType? purchaseId, DefaultIdType? paymentmodeId,
                        DefaultIdType? departmentId, DefaultIdType? expcategoryId, int? amount, DefaultIdType? transactiontypeId, string? description)
    {
        ...
        if (expcategoryId.HasValue && expcategoryId.Value != DefaultIdType.Empty && !ExpcategoryId.Equals(expcategoryId.Value)) ExpcategoryId = expcategoryId.Value;
