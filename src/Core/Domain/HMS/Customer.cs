...
public class Customer : AuditableEntity, IAggregateRoot
{
    ...
    public Customer(string name, string? addressLine1, string? addressLine2, string? city, string? country, string? pincode, string? phoneNumber, string? email, string? notes, DefaultIdType? custclassificationId)
    {
        Name = name;
    ...
    public Customer Update(string name, string? addressLine1, string? addressLine2, string? city, string? country, string? pincode, string? phoneNumber, string? email, string? notes, DefaultIdType? custclassificationId)
    {
